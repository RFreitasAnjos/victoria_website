...
const Contato = () => {
  return (
    <PageContainer>
      <section data-aos="fade-up" className="flex justify-around p-6 sm:p-8 md:p-12">
        <div>
          ...
          <div className="flex-1 flex flex-col justify-center gap-4 max-w-md mx-auto md:mx-0">
            ...
            <a
              ...
              className="relative bg-gradient-to-br from-pink-500 via-purple-500 to-yellow-400 rounded-xl shadow-lg overflow-hidden h-40 flex items-center justify-center hover:scale-105 transition-transform duration-300"
            >
